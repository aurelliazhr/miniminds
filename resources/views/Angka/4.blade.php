...
<head>
    ...
    <style>
        ...
        .huruf {
            ...
            color: #03a366;
            margin: 0;
            text-shadow: 5px 5px rgb(49, 226, 182);
        }
        ...
        button:hover {
            background-color: rgb(56, 231, 173);
            transform: scale(1.1);
        }
...
<body>
    <audio id="background-audio" loop>
        <source src="/..assets/backsoun4.mp3" type="audio/mpeg">
        Your browser does not support the audio element.
    </audio>

    <div class="container">
        <!-- Huruf Abjad -->
        <div class="huruf">4</div>
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route ('angka3')}}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('/..assets/c.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route ('angka5')}}"></a>
            </button>
        </div>
    </div>
