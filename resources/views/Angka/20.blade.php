...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/20.png" alt="" width="300px" height="250px">
        </div>

        <!-- Tombol Suara dan Navigasi -->
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route ('angka19')}}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('/..assets/20.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="belajar"></a>
            </button>
        </div>
    </div>
