...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #280457;
            margin: 0;
            text-shadow: 5px 5px rgb(111, 29, 179);
        }
        ...
        button:hover {
            background-color: rgb(88, 16, 156);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">13</div>

        <!-- <div class="image-container">
            <img src="/..assets/ayam.gif" alt="Gambar Ayam" onclick="playAudio('/..assets/aya13.mp3')">
        </div> -->

        <!-- Tombol Suara dan Navigasi -->
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route ('angka12')}}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('/..assets/13.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route ('angka14')}}"></a>
            </button>
        </div>
    </div>
