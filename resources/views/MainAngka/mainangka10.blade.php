...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <div class="row">
                <div class="6">
                    <img src="../assets/angka6.png" alt="Alif" data-correct="false" onclick="checkAnswer(this)" id="playImage"
                        data-audio="../assets/6.mp3" />
                    <audio src="../assets/6.mp3" id="audioClip"></audio>
                </div>
                <div class="9">
                    <img src="../assets/angka9.png" alt="Alif" data-correct="true" onclick="checkAnswer(this)" id="playImage9"
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                ...
                confirmButtonText: '<a href="{{ route('resultA') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
