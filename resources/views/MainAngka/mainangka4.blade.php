...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="soal3.html">
        ...
        <div class="Objek">
            <img src="../assets/bola.jpeg" alt="Pensil" />
        </div>
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'blue' || selectedColor === 'yellow') {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: '<a href="soal5.html" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
