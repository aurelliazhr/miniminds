...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Text">
            <p>Ada berapa banyak pensil di layar?</p>
        </div>
    </div>
        ...
        <div class="Pilihan">
            ...
            <button class="option" data-color="red" data-audio="../assets/5.mp3" data-correct="true" onclick="checkAnswer(this)">5</button>
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'blue' || selectedColor === 'yellow') {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    confirmButtonText: '<a href="{{ route('menebakAngka2') }}" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
