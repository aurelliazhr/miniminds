...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('menebakAngka6') }}">
        ...
        <div class="Pilihan">
            ...
            <button class="option" data-color="yellow" data-audio="../assets/2.mp3" data-correct="true" onclick="checkAnswer(this)">2</button>
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'blue' || selectedColor === 'red') {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    confirmButtonText: '<a href="{{ route('menebakAngka8') }}" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
