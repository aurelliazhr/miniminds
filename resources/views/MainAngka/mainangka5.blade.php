...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="soal4.html">
        ...
        <div class="Pilihan">
            ...
            <button class="option" data-color="red" data-audio="../assets/8.mp3">8</button>
            <button class="option" data-color="yellow" data-audio="../assets/1.mp3">1</button>
        </div>
    </div>
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'yellow' || selectedColor === 'red') {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: '<a href="soal6.html" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
