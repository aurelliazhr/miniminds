...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('menebakAngka4') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Ada berapa banyak rautan di layar?</p>
        </div>
        </div>

        <div class="Objek">
            <img src="../assets/rautan.jpeg" alt="Pensil" />
        </div>

        <div class="Pilihan">
            <button class="option" data-color="blue" data-audio="../assets/4.mp3" data-correct="true" onclick="checkAnswer(this)">4</button>
            <button class="option" data-color="red" data-audio="../assets/8.mp3" data-correct="false" onclick="checkAnswer(this)">8</button>
            <button class="option" data-color="yellow" data-audio="../assets/1.mp3" data-correct="false" onclick="checkAnswer(this)">1</button>
        </div>
    </div>
