...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <button class="option" data-color="red" data-audio="../assets/3.mp3">3</button>
            <button class="option" data-color="blue" data-audio="../assets/1.mp3">1</button>
            <button class="option" data-color="yellow" data-audio="../assets/6.mp3">6</button>
        </div>
    </div>
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'blue' || selectedColor === 'yellow') {
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'kucing ini bukan berjumlah ' + button.textContent.toLowerCase() + ', silahkan coba lagi!',
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    text: 'kucing ini berjumlah ' + button.textContent.toLowerCase() + '!',
