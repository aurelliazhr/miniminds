...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('menebakAngka7') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Ada berapa banyak kucing di layar?</p>
        </div>
        </div>

        <div class="Objek">
            <img src="../assets/kucing.jpg" alt="Pensil" />
        </div>

        <div class="Pilihan">
            <button class="option" data-color="red" data-audio="../assets/3.mp3" data-correct="true" onclick="checkAnswer(this)">3</button>
            <button class="option" data-color="blue" data-audio="../assets/1.mp3" data-correct="false" onclick="checkAnswer(this)">1</button>
            <button class="option" data-color="yellow" data-audio="../assets/6.mp3" data-correct="false" onclick="checkAnswer(this)">6</button>
        </div>
    </div>
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'blue' || selectedColor === 'yellow') {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    confirmButtonText: '<a href="{{ route('menebakAngka9') }}" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
