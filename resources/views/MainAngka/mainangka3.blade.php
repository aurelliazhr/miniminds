...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <button class="option" data-color="blue" data-audio="../assets/5.mp3" data-correct="false" onclick="checkAnswer(this)">5</button>
            <button class="option" data-color="red" data-audio="../assets/1.mp3" data-correct="true" onclick="checkAnswer(this)">1</button>
            <button class="option" data-color="yellow" data-audio="../assets/10.mp3" data-correct="false" onclick="checkAnswer(this)">10</button>
        </div>
    </div>
