...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="soal2.html">
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'blue' || selectedColor === 'yellow') {
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'penghapus ini bukan berjumlah ' + button.textContent.toLowerCase() + ', silahkan coba lagi!',
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    text: 'penghapus ini berjumlah ' + button.textContent.toLowerCase() + '!',
                    confirmButtonText: '<a href="soal4.html" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
