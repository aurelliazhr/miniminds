...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <button class="option" data-color="blue" data-audio="../assets/1.mp3" data-correct="true" onclick="checkAnswer(this)">1</button>
            <button class="option" data-color="red" data-audio="../assets/2.mp3" data-correct="false" onclick="checkAnswer(this)">2</button>
            <button class="option" data-color="yellow" data-audio="../assets/8.mp3" data-correct="false" onclick="checkAnswer(this)">8</button>
        </div>
    </div>
