...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="3.html">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>
        </div>

        <div class="Text">
            <p>Yang manakah huruf tsa?</p> <!-- Question as text -->
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/kho.jpg " alt="Alif" data-correct="false" />
                <img src="../assets/alif.jpg" alt="Ba" data-correct="false" />
            </div>
            <div class="row">
                <img src="../assets/tsa.jpg" alt="Ta" data-correct="true" />
            </div>
        </div>
    </div>
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                text: 'Ini adalah huruf tsa!',
                confirmButtonText: '<a href="5.html" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
        // Jika salah, tambahkan jumlah kesalahan dan tangani feedback
            ...
            if (wrongAttempts >= 2) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf tsa, silahkan coba lagi!',
                    confirmButtonText: 'OK'
                });
            }
        }
