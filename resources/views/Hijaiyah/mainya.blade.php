...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="27.html">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>
        </div>

        <div class="Text">
            <p>Yang manakah huruf ya?</p> <!-- Question as text -->
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/dal.jpg " alt="Alif" data-correct="false" />
                <img src="../assets/ya.jpg" alt="Ba" data-correct="true" />
            </div>
            <div class="row">
                <img src="../assets/alif.jpg" alt="Ta" data-correct="false" /> 
            </div>
        </div>
    </div>
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                text: 'Ini adalah huruf ya!',
                confirmButtonText: '<a href="1.html" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
        // Jika salah, tambahkan jumlah kesalahan dan tangani feedback
            ...
            if (wrongAttempts >= 2) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf ya, silahkan coba lagi!',
                    confirmButtonText: 'OK'
                });
            }
        }
