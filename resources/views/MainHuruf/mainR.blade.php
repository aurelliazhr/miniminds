...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('huruf4') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah huruf R?</p> <!-- Question as text -->
        </div>
    </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/c.png" alt="Alif" data-correct="false" />
                <img src="../assets/k.png" alt="Ba" data-correct="false" />
            </div>
            <div class="row">
                <img src="../assets/r.png" alt="Ta" data-correct="true" /> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/mainR.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                text: 'Ini adalah huruf R!',
                confirmButtonText: '<a href="{{ route('huruf6') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
        // Jika salah, tampilkan notifikasi kesalahan tanpa batasan jumlah
            ...
            Swal.fire({
                icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf R, silahkan coba lagi!',
