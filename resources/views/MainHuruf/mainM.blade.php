...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('huruf2') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah huruf M?</p> <!-- Question as text -->
        </div>
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/k.png" alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/m.png" alt="Ba" data-correct="true" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
...
window.onload = () => {
    playAudio('../assets/mainM.mp3'); // Menggunakan file audio yang sesuai
};
