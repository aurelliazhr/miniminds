...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('menebakH') }}">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/mainf.png" alt="Alif" data-correct="true" />
                <img src="../assets/mainp.png" alt="Ba" data-correct="false" />
            </div>
            <div class="row">
