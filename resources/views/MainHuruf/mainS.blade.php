...
window.onload = () => {
    playAudio('../assets/mainS.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                text: 'Ini adalah huruf S!',
                confirmButtonText: '<a href="{{ route('huruf7') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
        // Jika salah, tampilkan notifikasi kesalahan tanpa batasan jumlah
            ...
            Swal.fire({
                icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf S, silahkan coba lagi!',
