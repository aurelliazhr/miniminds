    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <div class="row">
                ...
                <img src="../assets/t.png" alt="Ba" data-correct="true" />
            </div>
            <div class="row">
                <img src="../assets/s.png" alt="Ta" data-correct="false" /> 
            </div>
        </div>
    </div>
    ...
    img.addEventListener('click', function() {
        ...
        // Jika salah, tampilkan notifikasi kesalahan tanpa batasan jumlah
            ...
            Swal.fire({
                icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf T, silahkan coba lagi!',
