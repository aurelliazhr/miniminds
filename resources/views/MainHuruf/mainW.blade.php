...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('huruf7') }}">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/c.png" alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/r.png" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/w.png" alt="Ta" data-correct="true" onclick="checkAnswer(this)"/> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/mainW.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('huruf9') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
