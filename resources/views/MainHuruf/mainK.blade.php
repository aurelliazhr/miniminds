    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <div class="row">
                ...
                <img src="../assets/c.png" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/k.png" alt="Ta" data-correct="true" onclick="checkAnswer(this)"/> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/mainK.mp3'); // Menggunakan file audio yang sesuai
};
