...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('huruf3') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah huruf Q?</p> <!-- Question as text -->
        </div>
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/f.png" alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/q.png" alt="Ba" data-correct="true" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/a.png" alt="Ta" data-correct="false" onclick="checkAnswer(this)"/> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/mainQ.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('huruf5') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
