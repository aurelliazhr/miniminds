...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/mainf.png" alt="Alif" data-correct="false" />
                <img src="../assets/mainq.png" alt="Ba" data-correct="true" />
            </div>
            <div class="row">
                <img src="../assets/maina.png" alt="Ta" data-correct="false" /> 
            </div>
        </div>
    </div>
        ...
        // Jika salah, tambahkan jumlah kesalahan dan tangani feedback
            ...
            if (wrongAttempts >= 2) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf Q, silahkan coba lagi!',
                    confirmButtonText: 'OK'
                });
            }
        }
