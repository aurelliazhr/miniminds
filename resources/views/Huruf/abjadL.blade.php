...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #0792d3;
            margin: 0;
            text-shadow: 5px 5px rgb(31, 209, 240);
        }
        ...
        button:hover {
            background-color: rgb(117, 226, 241);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/l.png" alt="" width="250px" height="250px">
        </div>
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route('Huruf11_') }}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/l.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route('Huruf13_') }}"></a>
            </button>
        </div>
    </div>
