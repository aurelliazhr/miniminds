...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #0d0ac2;
            margin: 0;
            text-shadow: 5px 5px rgb(137, 116, 255);
        }
        ...
        button:hover {
            background-color: rgb(129, 117, 241);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/i.png" alt="" width="250px" height="250px">
        </div>
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route('Huruf8_') }}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/i.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route('Huruf10_') }}"></a>
            </button>
        </div>
    </div>
