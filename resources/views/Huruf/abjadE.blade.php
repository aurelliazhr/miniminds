...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #0698d1;
            margin: 0;
            text-shadow: 5px 5px rgb(57, 191, 231);
        }
        ...
        button:hover {
            background-color: rgb(75, 186, 250);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/e.png" alt="" width="250px" height="250px">
        </div>
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route('Huruf4_') }}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/e.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route('Huruf6_') }}"></a>
            </button>
        </div>
    </div>
