...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/a.png" alt="" width="250px" height="250px">
        </div>

        <!-- <div class="image-container">
            <img src="/asset/ayam.gif" alt="Gambar Ayam" onclick="playAudio('/asset/ayam.mp3')">
        </div> -->
        ...
        <div class="btn-container">
            ...
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/a.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route('Huruf2_') }}"></a>
            </button>
        </div>
    </div>
