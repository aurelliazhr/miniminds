...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #8e0ac2;
            margin: 0;
            text-shadow: 5px 5px rgb(216, 116, 255);
        }
        ...
        button:hover {
            background-color: rgb(191, 117, 241);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/g.png" alt="" width="250px" height="250px">
        </div>
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route('Huruf6_') }}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/g.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route('Huruf8_') }}"></a>
            </button>
        </div>
    </div>
