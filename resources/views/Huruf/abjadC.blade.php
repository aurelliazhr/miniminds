...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #ff836d;
            margin: 0;
            text-shadow: 5px 5px rgb(240, 172, 151);
        }
        ...
        button:hover {
            background-color: rgb(231, 97, 56);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/c.png" alt="" width="250px" height="250px">
        </div>
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route('Huruf2_') }}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/c.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route('Huruf4_') }}"></a>
            </button>
        </div>
    </div>
