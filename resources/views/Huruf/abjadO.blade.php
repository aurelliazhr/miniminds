...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #0c7097;
            margin: 0;
            text-shadow: 5px 5px rgb(87, 205, 235);
        }
        ...
        button:hover {
            background-color: rgb(87, 205, 235);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/o.png" alt="" width="250px" height="250px">
        </div>
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route('Huruf14_') }}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/o.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{ route('Huruf16_') }}"></a>
            </button>
        </div>
    </div>
