...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/segi3.jpg" alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/bulat.jpg" alt="Ba" data-correct="true" onclick="checkAnswer(this)"/>
        </div>
    </div>
