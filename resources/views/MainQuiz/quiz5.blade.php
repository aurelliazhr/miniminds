...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="quiz4.html">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/segi3.jpg" alt="Alif" data-correct="false" />
                <img src="../assets/bulat.jpg" alt="Ba" data-correct="true" />
        </div>
    </div>
        ...
        img.addEventListener('click', function() {
            ...
            if (isCorrect) {
                Swal.fire({
                    ...
                    confirmButtonText: '<a href="quiz6.html" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            } else {
                Swal.fire({
                    icon: 'error',
