...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('quiz5') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah warna kuning?</p>
        </div>
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/yellow.jpg" alt="Ba" data-correct="true" onclick="checkAnswer(this)"/>
                <img src="../assets/green.jpg" alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
        </div>
    </div>
    ...
    window.onload = () => {
        playAudio('../assets/soal6quiz.mp3');
    };
        ...
        img.addEventListener('click', function() {
            ...
            if (isCorrect) {
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    confirmButtonText: '<a href="{{ route('quiz7') }}" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            } else {
                Swal.fire({
                    icon: 'error',
