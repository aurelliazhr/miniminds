...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="quiz2.html">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>
        </div>

        <div class="Text">
            <p>Yang manakah warna merah</p>
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/red.jpg" alt="Alif" data-correct="true" />
                <img src="../assets/green.jpg" alt="Ba" data-correct="false" />
        </div>
    </div>
    ...
    window.onload = () => {
        playAudio('../assets/soal3quiz.mp3');
    };
        ...
        img.addEventListener('click', function() {
            ...
            if (isCorrect) {
                Swal.fire({
                    ...
                    confirmButtonText: '<a href="quiz4.html" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            } else {
                Swal.fire({
                    icon: 'error',
