...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('quiz2') }}">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/red.jpg" alt="Alif" data-correct="true" onclick="checkAnswer(this)"/>
                <img src="../assets/green.jpg" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
        </div>
    </div>
