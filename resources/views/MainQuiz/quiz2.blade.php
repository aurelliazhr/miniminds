...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Objek">
            <img src="../assets/gajah.jpg" alt="Pensil" />
        </div>

        <div class="Pilihan">
            <button class="option" data-color="blue" data-audio="../assets/gajahquiz.mp3" data-correct="true" onclick="checkAnswer(this)">Gajah</button>
            <button class="option" data-color="red" data-audio="../assets/semutquiz.mp3" data-correct="false" onclick="checkAnswer(this)">Semut</button>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/soal2quiz.mp3');
};
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'red') {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    confirmButtonText: '<a href="{{ route('quiz3') }}" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
