...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Text">
            <p>yg manakah yg lebih pendek?</p>
        </div>
        ...
        <div class="Pilihan">
            <button class="option" data-color="blue" data-audio="../assets/manusiaquiz.mp3">manusia</button>
            <button class="option" data-color="red" data-audio="../assets/jerapahquiz.mp3">jerapah</button>
        </div>
    </div>
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'red') {
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'salah hewan ini lebih tinggi',
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    text: 'benar! orang ini lebih pendek',
