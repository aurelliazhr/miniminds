...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('quiz3') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah lebih pendek?</p>
        </div>
        </div>

        <div class="Objek">
            <img src="../assets/jerapah.jpeg" alt="Pensil" />
        </div>

        <div class="Pilihan">
            <button class="option" data-color="red" data-audio="../assets/jerapahquiz.mp3" data-correct="false" onclick="checkAnswer(this)">Jerapah</button>
            <button class="option" data-color="blue" data-audio="../assets/manusiaquiz.mp3" data-correct="true" onclick="checkAnswer(this)">Manusia</button>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/soal4quiz.mp3');
};
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'red') {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    confirmButtonText: '<a href="{{ route('quiz5') }}" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
