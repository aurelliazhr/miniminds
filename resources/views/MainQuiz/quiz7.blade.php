...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="quiz6.html">
        ...
        <div class="Objek">
            <img src="../assets/buku.jpg" alt="Pensil" />
        </div>
...
window.onload = () => {
    playAudio('../assets/soal7quiz.mp3');
};
        ...
        audio.onended = () => {
            ...
            if (selectedColor === 'blue') {
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'salah benda ini lebih besar',
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Benar!',
                    text: 'benar! benda ini lebih kecil',
                    confirmButtonText: '<a href="quiz8.html" style="color: white; text-decoration: none;">Lanjut</a>'
                });
            }
        };
    });
