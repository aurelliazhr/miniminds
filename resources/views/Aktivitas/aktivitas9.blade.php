...
<body>
    ...
    <div class="Kotak">
        <div class="Text">
            <img src="assets/surah.jpg" alt="">
            <p>Ajak orang tua untuk membaca surah bersama!</p>
        </div>

        <div class="Pilihan">
            <button class="option" data-color="red">
                <a href="{{ route ('aktivitas8')}}">Kembali</a>
            </button>
            <button class="option" data-color="blue">
                <a href="{{ route ('aktivitas10')}}">Lanjut</a>
            </button>
