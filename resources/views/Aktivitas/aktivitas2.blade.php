...
<body>
    ...
    <div class="Kotak">
        <div class="Text">
            <img src="assets/teman.jpg" alt="">
            <p>Ajak teman atau saudara untuk bermain!</p>
        </div>

        <div class="Pilihan">
            <button class="option" data-color="red">
                <a href="{{ route ('aktivitas1')}}">Kembali</a>
            </button>
            <button class="option" data-color="blue">
                <a href="{{ route ('aktivitas3')}}">Lanjut</a>
            </button>
        </div>
    </div>
