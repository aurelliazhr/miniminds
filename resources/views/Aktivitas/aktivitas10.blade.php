...
<body>
    ...
    <div class="Kotak">
        <div class="Text">
            <img src="" alt="">
            <img src="assets/olahraga.jpg" alt="">
            <p>Ajak orang tua untuk senam selama 10 menit!</p>
        </div>

        <div class="Pilihan">
            <button class="option" data-color="red">
                <a href="{{ route ('aktivitas9')}}">Kembali</a>
            </button>
            <button class="option" data-color="blue">
                <a href="{{route ('bermain') }}">Lanjut</a>
            </button>
