...
<body>
    ...
    <div class="Kotak">
        <div class="Text">
            <img src="assets/emosi.jpg" alt="">
            <p>Ajak orang tua untuk mengenal berbagai macam emosi!</p>
        </div>

        <div class="Pilihan">
            <button class="option" data-color="red">
                <a href="{{ route ('aktivitas3')}}">Kembali</a>
            </button>
            <button class="option" data-color="blue">
                <a href="{{ route ('aktivitas5')}}">Lanjut</a>
            </button>
