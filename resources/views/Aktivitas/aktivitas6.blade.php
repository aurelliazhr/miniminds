...
<body>
    ...
    <div class="Kotak">
        <div class="Text">
            <img src="assets/masak.jpg" alt="">
            <p>Ajak orang tua untuk menghitung berapa banyak sendok dirumah!</p>
        </div>

        <div class="Pilihan">
            <button class="option" data-color="red">
                <a href="{{ route ('aktivitas5')}}">Kembali</a>
            </button>
            <button class="option" data-color="blue">
                <a href="{{ route ('aktivitas7')}}">Lanjut</a>
            </button>
