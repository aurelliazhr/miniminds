...
<body>
    ...
    <div class="container">
        <!-- Huruf Abjad -->
        <div class="abjad">
            <img src="../assets/ba.png" alt="" width="250px" height="250px">
        </div>

        <!-- Tombol Suara dan Navigasi -->
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route ('hijaiyah_1')}}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/materiba.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{route('hijaiyah_3')}}"></a>
            </button>
        </div>
    </div>
