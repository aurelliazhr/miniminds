...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route ('hijaiyah_7')}}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('/..assets/materidal.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{route ('hijaiyah_9')}}"></a>
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = () => {
            playAudio('/..assets/materidal.mp3');
        };
    </script>
