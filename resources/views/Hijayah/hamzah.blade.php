...
<head>
    ...
    <style>
        ...
        .abjad {
            ...
            color: #ff4c82;
            margin: 0;
            text-shadow: 5px 5px rgb(255, 116, 174);
        }
        ...
        button:hover {
            background-color: rgb(241, 117, 189);
            transform: scale(1.1);
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route ('hijaiyah_28')}}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('../assets/materihamzah.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{route ('hijaiyah_30')}}"></a>
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = () => {
            playAudio('../assets/materihamzah.mp3');
        };
    </script>
