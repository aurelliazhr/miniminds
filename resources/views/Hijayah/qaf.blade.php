...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-container">
            <button id="backBtn">
                <a class="fa-solid fa-arrow-left" href="{{ route ('hijaiyah_21')}}"></a>
            </button>
            <button class="fa-solid fa-volume-up" data-letter="A" onclick="playAudio('/..assets/materiqaf.mp3')"></button>
            <button id="nextBtn">
                <a class="fa-solid fa-arrow-right" href="{{route ('hijaiyah_23')}}"></a>
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = () => {
            playAudio('/..assets/materiqaf.mp3');
        };
    </script>
