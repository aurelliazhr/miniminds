...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="5.html">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/dzal.jpg " alt="Alif" data-correct="false" />
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                ...
                confirmButtonText: '<a href="7.html" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
