...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('hijaiyah3') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah huruf Kha?</p> <!-- Question as text -->
        </div>
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/kho.jpg " alt="Alif" data-correct="true" onclick="checkAnswer(this)"/>
                <img src="../assets/ha.jpg" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
...
window.onload = () => {
    playAudio('../assets/kho.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('hijaiyah5') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
