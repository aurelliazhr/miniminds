...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/kho.jpg " alt="Alif" data-correct="true" />
                <img src="../assets/ha.jpg" alt="Ba" data-correct="false" />
            </div>
            <div class="row">
    ...
    img.addEventListener('click', function() {
        ...
        // Jika salah, tampilkan notifikasi kesalahan tanpa batasan jumlah
            ...
            Swal.fire({
                icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf kho, silahkan coba lagi!',
