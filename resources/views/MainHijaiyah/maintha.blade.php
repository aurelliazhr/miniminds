...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="15.html">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>
        </div>

        <div class="Text">
            <p>Yang manakah huruf Tha?</p> <!-- Question as text -->
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/to.jpg " alt="Alif" data-correct="true" />
                <img src="../assets/zai.jpg" alt="Ba" data-correct="false" />
            </div>
            <div class="row">
                <img src="../assets/fa.jpg" alt="Ta" data-correct="false" /> 
            </div>
        </div>
    </div>
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                text: 'Ini adalah huruf tho!',
                confirmButtonText: '<a href="17.html" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
        // Jika salah, tambahkan jumlah kesalahan dan tangani feedback
            ...
            if (wrongAttempts >= 2) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf tho, silahkan coba lagi!',
                    confirmButtonText: 'OK'
                });
            }
        }
