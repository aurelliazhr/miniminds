...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('hijaiyah8') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah huruf Ta?</p> <!-- Question as text -->
        </div>
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/haa.jpg" alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/ya.jpg" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/ta.jpg" alt="Ta" data-correct="true" onclick="checkAnswer(this)"/>
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/ta.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('hijaiyah10') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
