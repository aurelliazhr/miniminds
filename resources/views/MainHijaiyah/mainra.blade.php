...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('hijaiyah6') }}">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/dal.jpg " alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/sin.jpg" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/ra.jpg" alt="Ta" data-correct="true" onclick="checkAnswer(this)"/> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/ro.mp3'); // Menggunakan file audio yang sesuai
};
