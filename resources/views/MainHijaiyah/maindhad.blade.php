...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('hijaiyah1') }}">
...
window.onload = () => {
    playAudio('../assets/dhod.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('hijaiyah3') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
