...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Text">
            <p>Yang manakah huruf Ba?</p> <!-- Question as text -->
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/ha.jpg" alt="Alif" data-correct="false" />
                <img src="../assets/ba.jpg" alt="Ba" data-correct="true" />
            </div>
            <div class="row">
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                text: 'Ini adalah huruf ba!',
                confirmButtonText: '<a href="3.html" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
        // Jika salah, tambahkan jumlah kesalahan dan tangani feedback
            ...
            if (wrongAttempts >= 2) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Salah!',
                    text: 'Ini bukan huruf ba, silahkan coba lagi!',
                    confirmButtonText: 'OK'
                });
            }
        }
