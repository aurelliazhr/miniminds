...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('hijaiyah7') }}">
                <img src="../assets/angle-left.png" alt="Kembali" />
            </a>

        <div class="Text">
            <p>Yang manakah huruf Sin?</p> <!-- Question as text -->
        </div>
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/do.jpg" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/sin.jpg " alt="Alif" data-correct="true" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/ta.jpg" alt="Ta" data-correct="false" onclick="checkAnswer(this)"/> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/sin.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('hijaiyah9') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
        // Jika salah, tampilkan notifikasi kesalahan tanpa batasan jumlah
            ...
            Swal.fire({
                icon: 'error',
                title: 'Salah!',
                text: 'Ini bukan huruf sin, silahkan coba lagi!',
