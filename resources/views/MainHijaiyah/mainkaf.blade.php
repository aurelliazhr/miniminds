...
<body>
    ...
    <div class="Kotak">
        <div class="Header">
            <a id="kembaliButton" href="{{ route('hijaiyah2') }}">
        ...
        <div class="Pilihan">
            <div class="row">
                <img src="../assets/kho.jpg " alt="Alif" data-correct="false" onclick="checkAnswer(this)"/>
                <img src="../assets/fa.jpg" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/kaf.jpg" alt="Ta" data-correct="true" onclick="checkAnswer(this)"/> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/kaf.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('hijaiyah4') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
