...
<body>
    ...
    <div class="Kotak">
        ...
        <div class="Text">
            <p>Yang manakah huruf Dal?</p> <!-- Question as text -->
        </div>
        </div>

        <div class="Pilihan">
            <div class="row">
                <img src="../assets/dal.jpg " alt="Alif" data-correct="true" onclick="checkAnswer(this)"/>
                <img src="../assets/dzal.jpg" alt="Ba" data-correct="false" onclick="checkAnswer(this)"/>
            </div>
            <div class="row">
                <img src="../assets/zai.jpg" alt="Ta" data-correct="false" onclick="checkAnswer(this)"/> 
            </div>
        </div>
    </div>
...
window.onload = () => {
    playAudio('../assets/dal.mp3'); // Menggunakan file audio yang sesuai
};
    ...
    img.addEventListener('click', function() {
        ...
        if (isCorrect) {
            Swal.fire({
                icon: 'success',
                title: 'Benar!',
                confirmButtonText: '<a href="{{ route('hijaiyah2') }}" style="color: white; text-decoration: none;">Lanjut</a>'
            });
        } 
